                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-4">
                            ...
                            <p><strong>ADDRESS:</strong><br />Shyam Nagar, Behind Chandiwala Estate,
                                ...
                                New Delhi</p>
                            <p><strong>PHONE:</strong><br />9494209449 <br />8919531591</p>
                            <p><strong>EMAIL:</strong><br />admin@pikfusion.com</p>
                            <p><strong>FOLLOW US:</strong></p>
                            
                            <div className="d-flex gap-3">
                                <a href="" target="_blank" rel="noopener noreferrer">
                                    <i className="bi bi-facebook fs-5 text-black"></i>
                                </a>
                                <a href="https://www.instagram.com/pikfusion?igsh=MXIzYmMyOXNweXhyeA==" target="_blank" rel="noopener noreferrer">
                                    <i className="bi bi-instagram fs-5 text-black"></i>
                                </a>
                                <a href="" target="_blank" rel="noopener noreferrer">
                                    <i className="bi bi-twitter fs-5 text-black"></i>
                                </a>
                                <a href="" target="_blank" rel="noopener noreferrer">
                                    <i className="bi bi-youtube fs-5 text-black"></i>
                                </a>
                                <a href="https://www.linkedin.com/in/pikfusion-digital-studio" target="_blank" rel="noopener noreferrer">
                                    <i className="bi bi-linkedin fs-5 text-black"></i>
                                </a>
                            </div>
